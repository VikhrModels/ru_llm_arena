...
### Описание
Это инструмент для **автоматической** оценки моделей на **русском языке** с помощью **сильной LLM** **(GPT-4-1106-preview)** \
...
В отличие от [оригинального фреймворка](https://github.com/lm-sys/arena-hard-auto), содержит некоторые изменений:
...
Эта функция реализована примерно как в AlpacaEval 2 LC, но с некоторыми отличиями, которые можно увидеть в коде \
