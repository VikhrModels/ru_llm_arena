...
- Использование системы ELO рангов и предсказения винрейта с помощью [Bradley–Terry модели](https://en.wikipedia.org/wiki/Bradley–Terry_model) из пакета [Evalica](https://github.com/dustalov/evalica)
